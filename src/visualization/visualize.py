...
def visualize_detections(images_path, labels_path, image_name):

    image = load_image(f"{images_path}/{image_name}.jpg")
...
if __name__ == "__main__":
    ...
    visualize_detections(images_path, labels_path, image_name)